...
export default function AdminOverview() {
  ...
  return (
    <div>
      ...
      >
        <div style={cardStyle}>
          <p style={{ color: 'var(--white-muted)', fontSize: '.8rem', marginBottom: 6 }}>
            عدد المنتجات
          </p>
          <p style={{ color: 'var(--gold)', fontSize: '1.8rem', fontFamily: 'var(--font-display)' }}>
            {stats.totalProducts}
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {stats.topProducts.map(({ product, qty }) => (
            ...
            >
              ...
              <span style={{ color: 'var(--gold)', fontSize: '.84rem' }}>
                {qty} مبيعات
              </span>
            </div>
          ))}
